...
from social.forms import RegistrtationForm,LoginForm,UserProfileForm,PostForm
    ...
    def get_context_data(self, **kwargs):
        ...
        for p in userprofiles:
            for u in p.followings.all():
                lst.append(u)
        print("the followers are",lst.count(self.request.user))
